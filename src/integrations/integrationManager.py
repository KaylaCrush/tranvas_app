from src.integrations.canvasIntegration import CanvasIntegration, Assignment
...
class IntegrationManager:
    ...
    def place_assignment(self, assignment:Assignment):
        # 0 = available
        # 1 = due soon
        # 2 = doing
        # 3 = waiting for grade
        # 4 = graded
        if not assignment.has_duedate():
            return 0
    ...
    def create_assignment_card(self,assignment):
        assignment = assignment.data
        self.trello.cards.append(self.trello.request_create_card(
